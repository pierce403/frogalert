// FOSSASIA badgemagic-firmware 9ce885d, src/font.c (Apache-2.0).
// Exact 95-glyph fixture; firmware receives this same font from the C shell.
pub const FONT: [[u8; 6]; 95] = [
