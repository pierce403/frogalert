...
| Compatible with the BadgeMagic app legacy upload path | **VERIFIED** on both beta profiles | Survey keeps FOSSASIA `FEE0/FEE1` code and skips connected states; the user confirmed uploads on the released firmware line | Expand the compatibility matrix across Android/iOS app versions. |
